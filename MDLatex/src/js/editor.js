...
(function (document, window,) {
	...
	documentReady(function () {
      ...
      writeFile(parserCollection.getDisplayedResultFilename(), blob)
		});
    ...
    //
    //
    document.getElementsByClassName("header")[0].ondblclick=function(){
      var meta=document.createElement("meta");
      meta.setAttribute("http-equiv","refresh");
      meta.setAttribute("content","0;URL=index.html");
      document.head.appendChild(meta)      
    }
    loadMD(fileIn || "./sample/sample.md",function(data){ return parserCollection.setSource(data)});
    //
		(function () {
